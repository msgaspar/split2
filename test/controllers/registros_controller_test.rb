...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference("Registro.count") do
      post registros_url, params: { registro: { descricao: @registro.descricao, nome: @registro.nome } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { descricao: @registro.descricao, nome: @registro.nome } }
